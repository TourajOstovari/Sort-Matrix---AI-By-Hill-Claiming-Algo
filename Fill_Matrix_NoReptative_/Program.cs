    ...
    internal partial class Program
    {
        ...
        From_First_Again:
            ...
            Generate_again:
                    ...
                    case 0:
                        ...
                        for (int i = 0; i < 2; i++)
                        {
                            ...
                            if (i == 0)
                            {
                                ...
                                temp_buffer[1] = 0;
                                Temp_way = way + "-Right";
                                patterns_.Patterns_Alt.Add(new Rep_Data_Struct(temp_buffer, way + "-Right", G + Goal_Mark(temp_buffer)));
                            }
                            #endregion
                            #region Second_Step
                            if (i == 1)
                            {
                                ...
                                temp_buffer[3] = 0;
                                Temp_way = way + "-Down";
                                patterns_.Patterns_Alt.Add(new Rep_Data_Struct(temp_buffer, way + "-Down", G + Goal_Mark(temp_buffer)));
                            }
                            #endregion
                            #region Print_Job
                            int temp_counter = 0;
                    ...
                    case 1:
                        ...
                        for (int i = 0; i < 3; i++)
                        {
                            ...
                            if (i == 0)
                            {
                                ...
                                temp_buffer[0] = 0;
                                Temp_way = way + "-Left";
                                patterns_.Patterns_Alt.Add(new Rep_Data_Struct(temp_buffer, way + "-Left", G + Goal_Mark(temp_buffer)));
                            }
                            #endregion
                            #region Second_Step
                            if (i == 1)
                    ...
                    case 3:
                        ...
                        for (int i = 0; i < 3; i++)
                        {
                            ...
                            if (i == 0)
                            {
                                ...
                                temp_buffer[0] = 0;
                                Temp_way = way + "-Up";
                                patterns_.Patterns_Alt.Add(new Rep_Data_Struct(temp_buffer, way + "-Up", G + Goal_Mark(temp_buffer)));
                            }
                            #endregion
                            #region Second_Step
                            if (i == 1)
                ...
                G = patterns_.Patterns_Alt[0].G_;
                Rep_Data_Struct rep_Data_ = new Rep_Data_Struct();
                for (int i = 0; i < patterns_.Patterns_Alt.Count; i++)
                {
                    if (G >= patterns_.Patterns_Alt[i].G_)
                    {
                        buffer_ = (byte[])patterns_.Patterns_Alt[i].Pattern.Clone();
                        way = patterns_.Patterns_Alt[i].Pattern_way;
                        rep_Data_ = patterns_.Patterns_Alt[i];
                        G = patterns_.Patterns_Alt[i].G_;
                        list.Add(G);
                    }
                }
                //if (list.Contains(Goal_Mark(buffer_)) == true) Goal_Mark = true;
                        
                G = 0;
                patterns_.Patterns_Alt.Clear();
        ...
        public static byte Goal_Mark(byte[] Checksum)
        {
            byte mark = 0;
            if (Checksum[0] != 1) mark++;
            if (Checksum[1] != 2) mark++;
            if (Checksum[2] != 3) mark++;
            if (Checksum[3] != 4) mark++;
            if (Checksum[4] != 5) mark++;
            if (Checksum[5] != 6) mark++;
            if (Checksum[6] != 7) mark++;
            if (Checksum[7] != 8) mark++;
            if (Checksum[8] != 0) mark++;
            return mark;
        }
